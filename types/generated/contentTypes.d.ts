...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    big_description: Schema.Attribute.Text;
    created: Schema.Attribute.DateTime;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    form_users: Schema.Attribute.Relation<
      'manyToMany',
    ...
    > &
      Schema.Attribute.Private;
    pdfs: Schema.Attribute.Relation<'oneToMany', 'api::pdf.pdf'>;
    price: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    teacher: Schema.Attribute.String;
    teacher_image: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
...
export interface ApiFormUserFormUser extends Struct.CollectionTypeSchema {
  collectionName: 'form_users';
  info: {
    displayName: 'form_user';
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user_class: Schema.Attribute.String;
  };
}
...
export interface ApiTestiominalTestiominal extends Struct.CollectionTypeSchema {
  collectionName: 'testiominals';
  info: {
    displayName: 'Testiominal';
    pluralName: 'testiominals';
    singularName: 'testiominal';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::testiominal.testiominal'
    > &
      Schema.Attribute.Private;
    PostDescription: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
    Title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::testiominal.testiominal': ApiTestiominalTestiominal;
